...
public class DepreciationRuleServiceImpl implements DepreciationRuleService { 
    ...
    public DepreciationRuleServiceImpl(DepreciationRuleRepository repository) { this.repository = 
repository; } 
...
!"DECLINING_BALANCE".equals(rule.getMethod())) throw new IllegalArgumentException("Invalid 
method"); 
