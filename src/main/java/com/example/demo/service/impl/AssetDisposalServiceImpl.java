...
public class AssetDisposalServiceImpl implements AssetDisposalService { 
    ...
    public AssetDisposalServiceImpl(AssetDisposalRepository disposalRepo, AssetRepository 
assetRepo, UserRepository userRepo) { 
...
ResourceNotFoundException("Asset not found")); 
    ...
    @Override public AssetDisposal approveDisposal(Long disposalId, Long adminId) { 
        var disposal = disposalRepo.findById(disposalId).orElseThrow(() -> new 
ResourceNotFoundException("Disposal not found")); 
        var admin = userRepo.findById(adminId).orElseThrow(() -> new 
ResourceNotFoundException("Admin not found")); 
